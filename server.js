...
const mongoURI =
	"mongodb+srv://sansjo:technigo19@cluster0.xevnw.mongodb.net/skotrum-finalP?retryWrites=true&w=majority";

mongoose.connect(mongoURI, { useNewUrlParser: true, useUnifiedTopology: true });

mongoose.Promise = Promise;

const babyroommalmo = new Schema({
	name: String,
	address: String,
	phone: String,
	openHours: String,
...
const BabyRooms = mongoose.model("BabyRooms", babyrooms);
